...
THEME_PACKAGES=("i3" "feh" "xbacklight" "xinput" "i3blocks" "rxvt-unicode-256color" "screen" "scrot" "redshift" "alsa-utils" "acpi" "fonts-font-awesome" "xdotool" "xclip")
...
if [ ! -f "$I3_CONFIG_FILE" ]; then
	echo "Clonando arquivo de configuracao i3"
